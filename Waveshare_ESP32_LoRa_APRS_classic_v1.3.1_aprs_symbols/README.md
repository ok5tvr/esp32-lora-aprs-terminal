...
> Version 1.3.1 adds complete primary and alternate APRS symbol tables from
> the supplied reference chart, correct overlay handling and the corrected `//`
> generic-point tracker symbol. Version 1.3.0 TX scheduling, diagnostics and
...
## Complete APRS symbol tables in version 1.3.1
